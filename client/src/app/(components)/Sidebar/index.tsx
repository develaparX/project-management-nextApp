...
const Sidebar = () => {
  ...
  const sidebarClassNames = `fixed flex flex-col h-[100%] justify-between shadow-xl transision-all duration-300 h-full z-40 dark:bg-black overflow-y-auto bg-white w-64 `;
